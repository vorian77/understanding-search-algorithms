...
map_simple_dict = {
    0: {'pos': (9, 6), 'connections': [1, 2]},
    1: {'pos': (7, 4), 'connections': [3]},
    2: {'pos': (11, 5), 'connections': [4, 5]},
    3: {'pos': (5, 3), 'connections': [6, 7]},
    4: {'pos': (10, 3), 'connections': []},
    5: {'pos': (13, 2), 'connections': [8,9]},
    6: {'pos': (3, 2), 'connections': []},
    7: {'pos': (6, 1), 'connections': []},
    8: {'pos': (11, 0), 'connections': []},
    9: {'pos': (15, 0), 'connections': []}
}
...
def load_map_simple():
    G = load_map_graph(map_simple_dict)
    return Map(G)
